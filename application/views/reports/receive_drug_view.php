...
<ul class="breadcrumb">
    ...
    <li class="active" >จำนวนผู้ป่วได้รับยา ACEi/ARB<span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<table class="table table-bordered " id='tbl_list'>
        ...
        <tr>
            ...
            <th >ชื่อหน่วย</th>
            <th >จำนวน CKD </th>
            <th >ได้รับยา ACEi/ARB</th>
            <th >ไม่ได้รับยา ACEi/ARB</th>
        </tr>
        </thead>
        <tbody>
        <tr>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.receive_drug.js" charset="utf-8"></script>
