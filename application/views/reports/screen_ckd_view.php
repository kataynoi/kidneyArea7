...
<ul class="breadcrumb">
    ...
    <li class="active">จำนวนผู้ป่วย  CKD ได้รับการคัดกรองโรคไตเรื้อรัง <span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.screen_ckd.js" charset="utf-8"></script>
