...
<ul class="breadcrumb">
    ...
    <li class="active" > จำนวนผู้ป่วยที่มีระดับ LDL Cholesterol < 100 mg% Modify<span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<table class="table table-bordered table-hover" id='tbl_list'>
        ...
        <tr>
            ...
            <th >ชื่อหน่วย</th>
            <th >จำนวน CKD </th>
            <th >จำนวน CKD ที่ด้รับการตรวจ LDL</th>
            <th > LDL < 100 mg% </th>
            <th > LDL > 100 mg%</th>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.ldl_new.js" charset="utf-8"></script>
