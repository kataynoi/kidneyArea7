...
<ul class="breadcrumb">
    ...
    <li class="active" >จำนวนผู้ป่วยได้รับระดับ Serum PO4  <  4.5 mg% <span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<table class="table table-bordered table-hover " id='tbl_list'>
        ...
        <tr>
            ...
            <th >ชื่อหน่วย</th>
            <th >จำนวน CKD </th>
            <th >จำนวนผู้ได้รับการตรวจ  Serum PO4</th>
            <th >Serum PO4  <  4.5 mg%</th>
            <th >Serum PO4  >  4.5 mg%</th>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.serumPO4.js" charset="utf-8"></script>
