...
<ul class="breadcrumb">
    ...
    <li class="active" > จำนวนผู้ป่วย  CKD Stage 5 ได้รับการตรวจ iPTH ที่เหมาะสม ( iPTH 150-300 pg/ml)<span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<table class="table table-bordered table-hover " id='tbl_list'>
        <thead>
        <tr>
            <th >#</th>
            <th >ชื่อหน่วย</th>
            <th >จำนวน CKD ที่ด้รับการตรวจ iPTH</th>
            <th >iPTH 150-300 pg/ml</th>
            <th >iPTH ไม่อยู่ในช่วง 150-300 pg/ml</th>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.iPTH_5.js" charset="utf-8"></script>
