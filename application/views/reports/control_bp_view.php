...
<ul class="breadcrumb">
    ...
    <li class="active">จำนวนผู้ป่วย  CKD Bp<130/80  Orliginal <span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.control_bp.js" charset="utf-8"></script>
