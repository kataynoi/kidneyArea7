...
<ul class="breadcrumb">
    ...
    <li class="active" > จำนวนผู้ป่วย ที่มีค่า  serum HCO3 > 22 mEq/L <span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<table class="table table-bordered table-hover " id='tbl_list'>
        ...
        <tr>
            ...
            <th >ชื่อหน่วย</th>
            <th >จำนวน CKD </th>
            <th >จำนวน CKD ที่ด้รับการตรวจ serum HCO3</th>
            <th > serum HCO3 > 22 mEq/L</th>
            <th > serum HCO3 < 22 mEq/L </th>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.serumHCO3.js" charset="utf-8"></script>
