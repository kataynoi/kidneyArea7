...
<ul class="breadcrumb">
    ...
    <li class="active" > จำนวนผู้ป่วยที่มีระดับ HbA1c < 7 % Modify<span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.dm_hba1c_new.js" charset="utf-8"></script>
