...
<ul class="breadcrumb">
    ...
    <li class="active" > จำนวนผู้ป่วยได้รับการประเมิน UPCR <span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<table class="table table-bordered table-hover " id='tbl_list'>
        ...
        <tr>
            ...
            <th >ชื่อหน่วย</th>
            <th >จำนวน CKD </th>
            <th > ได้รับการตรวจประเมิน UPCR</th>
            <th > ไม่ได้รับการตรวจประเมิน UPCR</th>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.upcr.js" charset="utf-8"></script>
