...
<ul class="breadcrumb">
    ...
    <li class="active" > จำนวนผู้ป่วยได้รับการตรวจ  urine Protein โดยใช้แถบสีจุ่ม (dipstick) Original <span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.urineprotein.js" charset="utf-8"></script>
