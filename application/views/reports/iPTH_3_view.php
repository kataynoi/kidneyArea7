...
<ul class="breadcrumb">
    ...
    <li class="active" > จำนวนผู้ป่วย  CKD Stage 3 ได้รับการตรวจ iPTH ที่เหมาะสม ( iPTH 35-70 pg/ml)<span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<table class="table table-bordered table-hover " id='tbl_list'>
        ...
        <tr>
            ...
            <th >iPTH 35-70 pg/ml</th>
            <th >iPTH ไม่อยู่ในช่วง 35-70 pg/ml</th>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.iPTH_3.js" charset="utf-8"></script>
