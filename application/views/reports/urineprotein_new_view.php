...
<ul class="breadcrumb">
    ...
    <li class="active" > จำนวนผู้ป่วยได้รับการตรวจ  urine Protein โดยใช้แถบสีจุ่ม (dipstick) Modify<span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<table class="table table-bordered table-hover " id='tbl_list'>
        ...
        <tr>
            ...
            <th >ชื่อหน่วย</th>
            <th >จำนวน CKD </th>
            <th > ได้รับการตรวจ Urine Protein</th>
            <th > ไม่ได้รับการตรวจ Urine Protein</th>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.urineprotein_new.js" charset="utf-8"></script>
