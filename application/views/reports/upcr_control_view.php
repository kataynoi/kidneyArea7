...
<ul class="breadcrumb">
    ...
    <li class="active" >จำนวนผู้ป่วยได้รับระดับ UPCR  <  500 mg/g cr <span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<table class="table table-bordered table-hover " id='tbl_list'>
        ...
        <tr>
            ...
            <th >ชื่อหน่วย</th>
            <th >จำนวน CKD </th>
            <th >จำนวนผู้ได้รับการตรวจ  UPCR</th>
            <th >UPCR  <  500 mg/g cr</th>
            <th >UPCR  >  500 mg/g cr</th>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.upcr_control.js" charset="utf-8"></script>
