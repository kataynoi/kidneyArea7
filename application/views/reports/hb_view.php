...
<ul class="breadcrumb">
    ...
    <li class="active" > จำนวนผู้ป่วยที่มีระดับ HB > 10 gm/dl<span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<table class="table table-bordered " id='tbl_list'>
        ...
        <tr>
            ...
            <th >ชื่อหน่วย</th>
            <th >จำนวน CKD </th>
            <th >จำนวน CKD ที่ด้รับการตรวจ HB </th>
            <th > HB > 10 gm/dl</th>
            <th > HB < 10 gm/dl</th>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.hb.js" charset="utf-8"></script>
