...
<ul class="breadcrumb">
    ...
    <li class="active" > จำนวนผู้ป่วยที่มีระดับ LDL Cholesterol < 100 mg% Original<span class='badge alert-danger'></span> <span class='badge alert-success'>ประมวล</span></li>
</ul>
...
<script src="<?php echo base_url()?>assets/apps/js/reports.ckd.ldl.js" charset="utf-8"></script>
