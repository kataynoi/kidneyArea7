$(function () {
    ...
    var rpt={};
    reports.ajax = {
        get_control_iPTH3: function (year,prov_code,cb) {
            var url = '/reports/get_control_iPTH3',
                params = {
                    year: year,
                    prov_code:prov_code
                }
    ...
    reports.set_control_iPTH3 = function (data) {
        var no=1;
    ...
    reports.get_control_iPTH3 = function (year,prov_code) {
        reports.ajax.get_control_iPTH3(year,prov_code, function (err,data) {

            if (err) {
                app.alert(err);
                $('#tbl_list > tbody').append('<tr><td colspan="4">ไม่พบรายการ</td></tr>');
            } else {
                reports.set_control_iPTH3(data);
    ...
    $(document).on('click', '#btn_show', function () {
        ...
        if (!year) {
            ...
            reports.get_control_iPTH3(year,prov_code);
...
// ############  Set_chart
    ...
    rpt.chart.set_chart = function(data){
        var options = {
            ...
            title: {
                text: ' จำนวนผู้ป่วย CKD Stage 3 ได้รับการตรวจ iPTH ที่เหมาะสม ( iPTH 35-70 pg/ml) '
            },
            xAxis: {
                categories: []
            },
            ...
            series: [{
                name: ' iPTH 35-70 pg/ml',
                data: []
            }, {
                name: 'iPTH Not Between 35-70 pg/ml',
                data: []
            }]
        };
